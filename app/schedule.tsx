...
function getNext7Days(): { date: Date; dayName: string; dayNum: number; month: string; fullDate: string }[] {
  const days = [];
...
export default function ScheduleScreen() {
  ...
  const monthName = selectedDateObj.month;
    ...
    <View style={[styles.container, { backgroundColor: isDark ? Colors.backgroundDark : Colors.background }]}>
      ...
      >
        ...
        <Animated.View entering={FadeInDown.duration(300).delay(50)}>
          <Text style={[styles.monthTitle, { color: isDark ? Colors.textDark : Colors.text }]}>{monthName}</Text>
        </Animated.View>
            ...
            {dates.map((d) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.datePill,
                    isSelected ? { backgroundColor: Colors.primary } : { backgroundColor: isDark ? Colors.surfaceDark : Colors.surface, borderColor: isDark ? Colors.borderDark : Colors.border },
                  ]}
                ...
                >
                  ...
                  {isToday && <View style={[styles.todayDot, isSelected && { backgroundColor: '#111' }]} />}
                </TouchableOpacity>
              );
            })}
          </ScrollView>
                ...
                >
                  <Text
                    style={[
                      ...
                      isSelected && { color: '#111', fontWeight: '800' },
                    ]}
                  >
                    {slot.time}
                  </Text>
                  {slot.available && (
                    <Text style={[styles.timeSlotPrice, isSelected && { color: '#111' }]}>
        ...
        {/* Pricing note */}
        <Text style={[styles.pricingNote, { color: isDark ? Colors.textTertiaryDark : Colors.textTertiary }]}>
      ...
      <View style={[styles.bottomBar, { paddingBottom: Math.max(insets.bottom, 12), backgroundColor: isDark ? Colors.backgroundDark : Colors.background }]}>
        <View style={styles.bottomBarInner}>
          ...
          <TouchableOpacity
            style={[styles.continueButton, !selectedTimeSlot && { opacity: 0.5 }]}
